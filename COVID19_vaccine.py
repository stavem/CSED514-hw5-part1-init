...
class COVID19Vaccine:
    def __init__(self, name, supplier, available_doses, reserved_doses, total_doses,
        ...
        self.sqltext = f"""INSERT INTO Vaccines (VaccineName, VaccineSupplier, AvailableDoses, 
        ReservedDoses, TotalDoses, DosesPerPatient, DaysBetweenDoses) VALUES ({name}, {supplier}, 
        {available_doses}, {reserved_doses}, {total_doses}, {doses_per_patient},
     {days_between_doses})"""
